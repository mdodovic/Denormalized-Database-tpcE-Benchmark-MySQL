DROP TABLE IF EXISTS tpce_mysql.HOLDING_SUMMARY CASCADE;
DROP TABLE IF EXISTS tpce_mysql.LAST_TRADE CASCADE;
DROP TABLE IF EXISTS tpce_mysql.CUSTOMER_ACCOUNT CASCADE;
DROP TABLE IF EXISTS tpce_mysql.CUSTOMER CASCADE;
